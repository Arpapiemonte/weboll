...
<template>
  ...
  >
    <template #th1="slotProps">
      ...
      >
        Num {{ slotProps.currentSort === 'numero_bollettino' ? slotProps.currentSortDir === 'asc' ? '▲' : '▼' : ' ' }}
      </th>
      <th
        scope="col"
        role="button"
      ...
      >
        ora {{ slotProps.currentSort === 'ora_emissione' ? slotProps.currentSortDir === 'asc' ? '▲' : '▼' : ' ' }}
      </th>
      <th
        scope="col"
        role="button"
      ...
      >
        pdf ordinario {{ slotProps.currentSort === 'pdf_ordinario' ? slotProps.currentSortDir === 'asc' ? '▲' : '▼' : ' ' }}
      </th>
    </template>
