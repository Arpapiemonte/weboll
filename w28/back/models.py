...
class W28(models.Model):
    id_w28 = models.BigAutoField(primary_key=True)
    start_valid_time = models.DateTimeField()
    validity = models.IntegerField()
    next_blt_time = models.DateTimeField()
    status = models.CharField(max_length=1)
    id_w28_parent = models.IntegerField(blank=True, null=True)
...
class W28Data(models.Model):
    id_w28 = models.ForeignKey(W28, models.DO_NOTHING, db_column="id_w28")
    id_w28_data = models.AutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = "w28_data"
        unique_together = (("id_w28", "id_venue", "id_time_layouts"),)
